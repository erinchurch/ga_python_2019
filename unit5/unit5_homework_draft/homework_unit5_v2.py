...
# ADD CLASS OR METHODS FOR ACCESSING FILES, LIKELY INTO INIT (done)
# STORE DATA IN LOCAL DICTIONARIES (done)
# ACCOUNT DATA
# USER ATM AUTHENTICATION (done)
#FIRM AUTHENTICATION (done)
# WRITE TRANSACTION DATA OUT INTO THE TRANSACTION HISTORY FILE
# CONSIDER INCORPORATING TIME STAMP INTO THE KEY
