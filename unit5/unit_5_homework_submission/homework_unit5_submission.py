...
class Transactions: #class for all transaction types supported
    ...
    def __init__(self):
        ...
        f_account = self.f_file["accounts"]
        f_account_head = self.f_file["header"]
...
class Client:
    ...
    def client_bank(self):
        ...
        try:
            ...
            while True:
                bank_choice = input("To start a New transaction, type N, or to Exit, type E.\t")
                if bank_choice == "N" or bank_choice == "n":
                ...
                elif bank_choice == "e" or bank_choice == "E":
                    print("Thank you.")
                    exit()
                else:
    ...
    def client_teller(self):
        ...
        try:
            ...
            while True:
                ...
                if teller_choice == "N" or teller_choice == "n":
                ...
                elif teller_choice == "e" or teller_choice == "E":
                    print("Thank you.")
                    exit()
                else:
